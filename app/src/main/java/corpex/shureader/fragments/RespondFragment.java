 ...
 * {@link RespondFragment.OnRespondFragmentListener} interface
...
public class RespondFragment extends Fragment {
    ...
    private OnRespondFragmentListener mListener;
    ...
    public static RespondFragment newInstance(String param1, String param2) {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ContentFragment.OnContentFragmentListener) {
            mListener = (RespondFragment.OnRespondFragmentListener) context;
        } else {
    ...
    public interface OnRespondFragmentListener {
        void openDrawer();
    }
}
